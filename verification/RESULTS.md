...
| L1-03-floating-promise | await 忘れで Promise を放置する | L1 | l1-lint, l3-test | ✅ 一致 ※設定ずれ: l3-test 期待 pass → 実測 fail |
...
| L2-02-guard-missing | Controller から認可ガードを外す | L2 (l2-semgrep) | l2-semgrep, l3-test | ✅ 一致 ※設定ずれ: l3-test 期待 pass → 実測 fail |
...
| L3-03-authz-bypass | 認可チェック（所有者確認）が欠落する | L2 (l2-semgrep) | l1-typecheck, l1-lint, l3-test | ⚠️ 判定不能 |
