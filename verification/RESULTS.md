...
| L5-01-duplicate-logic | 割引ロジックを Web 側に二重実装する | L5 (l5-ai-review) | （なし） | ❌ どの層も止めなかった |
| L5-02-n-plus-one | 注文一覧で N+1 クエリを発生させる | L5 (l5-ai-review) | l3-test | ❌ 別の層が止めた |
| L5-03-missing-boundary-test | 境界値テストを欠落させる | L5 (l5-ai-review) | （なし） | ❌ どの層も止めなかった |
